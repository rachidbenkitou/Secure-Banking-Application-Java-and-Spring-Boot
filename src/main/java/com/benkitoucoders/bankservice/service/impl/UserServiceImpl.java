...
public class UserServiceImpl implements UserService {
    ...
    public BankResponse transfer(TransferRequest request) {
        // Get the account to debit(check i user exists)
        ...
        sourceAccountUser
                .setAccountBalance(sourceAccountUser.getAccountBalance()
        ...
        EmailDetails creditAlert = EmailDetails.builder()
                ...
                .recipient(sourceAccountUser.getEmail())
                .messageBody("The sum of " + request.getAmount() + " has been sent to your account from " + sourceUsername + "! Your current balance is " + sourceAccountUser.getAccountNumber())
                .build();
